...
function setup_framework_options()
{
    ...
    $args['opt_name'] = 'blog-theme';

    //Custom menu icon
    //$args['menu_icon'] = '';

    //Custom menu title for options page - default is "Options"
    $args['menu_title'] = __('blog-theme', 'nhp-opts');

    //Custom Page Title for options page - default is "Options"
    $args['page_title'] = __('blog-theme', 'nhp-opts');
    ...
    $sections[] = array(
        ...
        'fields' => array(
            array(
                ...
                'sub_desc' => __('Upload your logo <strong>(286 x 50 px)</strong> using the Upload Button or insert image URL.', 'nhp-opts')
            ),
            array(
                'id' => 'mts_favicon',
                'type' => 'upload',
